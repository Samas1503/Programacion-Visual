...
public class calculadora {
	...
	public calculadora(int suma, int resta, float division, int multiplicacion) {
		super();
		this.suma = suma;
		this.resta = resta;
	...
	public int hashCode() {
		...
		result = prime * result + Float.floatToIntBits(multiplicacion);
		...
		result = prime * result + Float.floatToIntBits(resta);
	...
	public boolean equals(Object obj) {
		...
		if (modelo == null) {
			...
			return false;
		if (Float.floatToIntBits(multiplicacion) != Float.floatToIntBits(other.multiplicacion))
			return false;
		if (multiplicar == null) {
		...
		if (operando2 != other.operando2)
			return false;
		if (Float.floatToIntBits(resta) != Float.floatToIntBits(other.resta))
			return false;
		if (restar == null) {
